...
class CatalogActivity : ComponentActivity() {
    ...
    fun cargarPeliculas(){
        ...
        series.add(Pelicula("Dr. Who", R.drawable.drwho,R.drawable.drwho,"Traveling across time and space, the immortal time-lord known as &#39;The Doctor&#39; travels across the universe with his many companions and his loyal shape-shifting space-ship: The TARDIS. The Doctor faces many threats across many generations: from The Daleks, The Cybermen and his time-lord adversary The Master to the sinister Davros, creator of The Daleks."))
